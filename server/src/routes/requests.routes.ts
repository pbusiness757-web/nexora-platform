...
import assignPartnerController = require("../controllers/assignPartner.controller");
...
router.get("/export",      requestsController.exportCsv);
...
router.post("/:id/assign-partner", assignPartnerController.assignPartner);
